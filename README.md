...
**Software:** Python (Pandas, Numpy, scikit-learn, matplotlib), SQL, Microsoft Office (Excel, Word, Powerpoint)
...
**Software:** Python (PyTorch, Pandas, Numpy, scikit-learn, matplotlib, NLTK, HuggingFace, SBERT), Linux
